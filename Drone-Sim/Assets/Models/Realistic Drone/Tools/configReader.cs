...
/// <summary>
/// Class used to read a PID2 configuration and inject into the drone automatically.
...
public class configReader : MonoBehaviour {
    ...
    protected void writeKeysOnDMC(float[] myVals)
    {
        ...
        PID2 yPID = new PID2(myVals[0], myVals[1], myVals[2], myVals[3]);
        PID2 zPID = new PID2(myVals[4], myVals[5], myVals[6], myVals[7]);
        PID2 xPID = new PID2(myVals[4], myVals[5], myVals[6], myVals[7]);
        PID2 yawPID = new PID2(myVals[8], myVals[9], myVals[10], myVals[11]);
        PID2 rollPID = new PID2(myVals[12], myVals[13], myVals[14], myVals[15]);
        PID2 pitchPID = new PID2(myVals[12], myVals[13], myVals[14], myVals[15]);

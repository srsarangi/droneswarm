...
public class FlockUnitNew : MonoBehaviour
{
	...
	private List<FlockUnitNew> cohesionNeighbours = new List<FlockUnitNew>();
	private List<FlockUnitNew> avoidanceNeighbours = new List<FlockUnitNew>();
	private List<FlockUnitNew> aligementNeighbours = new List<FlockUnitNew>();
	private FlockNew assignedFlock;
	...
	public void AssignFlock(FlockNew flock)
	{
		assignedFlock = flock;
	}
	...
	public void MoveUnit()
	{
		...
		var migrationVector = CalculateMigrationVector() * assignedFlock.migrationWeight;

		var moveVector = cohesionVector + avoidanceVector + aligementVector + boundsVector + obstacleVector + migrationVector;
	...
	private Vector3 CalculateMigrationVector()
	{
		Vector3 migration = Vector3.zero;
		//migration = leader.transform.position - myTransform.position;
		migration = leader.GetComponent<Rigidbody>().velocity;
		migration = migration.normalized;
		return migration;
	}

...
public class Rey2CamObs : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else  // Every other frame
        {
            ...
            for (int p = 0; p < obstacleLeft.Count; p++) //Left  obstacle
            {
                ...
                int minpix_y = obstacleLeft[p].Item1.Item1.Item1;
                int maxpix_x = obstacleLeft[p].Item1.Item2.Item2;
                int maxpix_y = obstacleLeft[p].Item1.Item2.Item1;
                float z_depth = obstacleLeft[p].Item2;
                Debug.Log("minpix " + minpix_x);
                float mindisp_x = 0;
                float mindisp_y = 0;
                float maxdisp_x = 0;
                float maxdisp_y = 0;
            ...
            for (int p = 0; p < obstacleRight.Count; p++)// right obstacle
            {
                ...
                int maxpix_x = obstacleRight[p].Item1.Item2.Item2;
                int maxpix_y = obstacleRight[p].Item1.Item2.Item1;
